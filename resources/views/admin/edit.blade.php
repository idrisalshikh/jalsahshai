...
<div class="container mx-auto p-8">
    <h1 class="text-3xl font-bold mb-6">Edit Game Session</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('admin.sessions.update', $session->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" id="code" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" value="{{ $session->code }}" required>
            </div>
            <div class="mb-4">
